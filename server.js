...
const server = http.createServer(async (req, res) => {
  ...
  // API routes
  if (pt.startsWith("/v1/") || pt.startsWith("/register") || pt.startsWith("/login") || pt.startsWith("/logout") || pt.startsWith("/me") || pt.startsWith("/chats") || pt.startsWith("/projects") || pt.startsWith("/community/chat") || pt.startsWith("/plugin/") || pt.startsWith("/api/") || pt.startsWith("/account/") || pt.startsWith("/admin/") || pt.startsWith("/discord/") || pt.startsWith("/stats")) {
